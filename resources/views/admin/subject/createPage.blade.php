                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="card-title">
                                        <h3 class="text-center title-2">Create Subject </h3>
                                    </div>
                                    <hr>
                                    <form action="{{route('subject#create')}}" enctype='multipart/form-data' method="post" novalidate="novalidate">
                                        @csrf
                                        <div class="form-group">
                                            <label for="cc-payment" class="control-label mb-1">Subject Name</label>
                                            <input id="cc-pament" name="subjectName" type="text" class="form-control" aria-required="true" aria-invalid="false" placeholder="မြန်မာဖတ်စာ...">
                                        </div>
                                         <div class="form-group">
