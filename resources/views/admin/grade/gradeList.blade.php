                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="col-md-12">
                            ...
                            <div class="table-data__tool">
                                <div class="table-data__tool-left">
                                    <div class="overview-wrap">
                                        <h2 class="title-1">Grade List</h2>

                                    </div>
                                </div>
                                <div class="table-data__tool-right">
                                    <a href="{{route('grade#createPage')}}">
                          ...
                          <div class="row ">
                              <form action="{{route('grade#list')}}" method="get" class="offset-8 text-end">
                                @csrf
                               <div class="d-flex">
                                 <input value="{{request('searchKey')}}" type="text" name="searchKey"  class="p-2 form-contorl" placeholder="Search Grade...">
                                        ...
                                        <tr class="tr-shadow">
                                            ...
                                            <td>
                                                <div class="table-data-feature">
                                                    ...
                                                    <a href="{{route('grade#editPage',$g->id)}}">
                                                    <button class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                                        <i class="zmdi zmdi-edit"></i>
                                                    </button></a>
                                                   <a href="{{route('grade#delete',$g->id)}}">
